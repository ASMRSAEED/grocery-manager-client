...
const Blogs = () => {
    return (
        <div className='questions'>
            ...
            <h2 className="question-1 fw-bold text-start pt-3">
                {" "}
            ...
            <h2 className="question-2 fw-bold text-start pt-3">
            ...
            <h2 className="question-3 fw-bold text-start pt-3">
            ...
            <h2 className="question-4 fw-bold text-start pt-3">
